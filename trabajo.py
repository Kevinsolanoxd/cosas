...
Resultado.grid(columnspan=3 , row=0, pady=4,padx=2, ipadx=1, ipady=1) 

#fila 1
Button1 = HoverButton(frame, text= "1", borderwidth=2, height=2, width=5, 
	font= ('Comic sens MC',12,'bold'),relief = "raised", activebackground="navajowhite3", bg ='peachpuff2',  
...
Button2 = HoverButton(frame, text= "2", height=2, width=5, 
	font= ('Comic sens MC',12,'bold'), borderwidth=2,  relief = "raised", activebackground="navajowhite3",bg ='peachpuff2', 
...
Button_borrar = HoverButton(frame, text= "⌫", height=2, width=5,
	font= ('Comic sens MC',12,'bold'), borderwidth=2,  relief = "raised", activebackground="indian red", 
	bg='saddle brown',  anchor="center",command=lambda: borrar_uno())  
...
Button4 = HoverButton(frame, text= "4",height=2, width=5,font= ('Comic sens MC',12,'bold'), 
	borderwidth=2,  relief = "raised", activebackground="navajowhite3", bg ='peachpuff2', anchor="center",
